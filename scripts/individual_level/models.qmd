...
```{r}
#| label: tbl-nested-logit
#| results: asis

resizebox.stargazer(models(m3.nested.naive), 
...
The model doesn't converge. Check if we can achieve convergence with other optimizers.
